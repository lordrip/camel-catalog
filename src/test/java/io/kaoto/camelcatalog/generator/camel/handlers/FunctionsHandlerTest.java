...
class FunctionsHandlerTest {
    FunctionsHandler functionsGenerator;
    ...
    void shouldMockLanguageModelGetFunctions() {
        ...
        functionsGenerator = new FunctionsHandler(spyCatalog, camelCatalogVersionLoader);
    ...
    void shouldLogWarningAndReturnEmptyOnInvalidSimpleLanguageJson() {
        ...
        Logger logger = Logger.getLogger(FunctionsHandler.class.getName());
        ...
        functionsGenerator = new FunctionsHandler(spyCatalog, mockLoader);
