...
public class FunctionsHandler implements CatalogEntryHandler {
    private static final Logger LOGGER = Logger.getLogger(FunctionsHandler.class.getName());
    private final ObjectMapper jsonMapper;
    private final CamelCatalog camelCatalog;
    private final CamelCatalogVersionLoader camelCatalogVersionLoader;

    public FunctionsHandler(CamelCatalog camelCatalog, CamelCatalogVersionLoader camelCatalogVersionLoader) {
